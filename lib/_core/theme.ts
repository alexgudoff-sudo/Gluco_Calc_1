...
type SchemePalette = Record<"light" | "dark", Record<ThemeColorName, string>>;
type SchemePaletteItem = SchemePalette["light" | "dark"];
...
function buildRuntimePalette(scheme: "light" | "dark"): RuntimePalette {
...
} satisfies Record<"light" | "dark", RuntimePalette>;

export type ThemeColorPalette = (typeof Colors)["light" | "dark"];
